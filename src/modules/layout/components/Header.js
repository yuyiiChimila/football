        ...
        <Container>
          <Row>
            ...
            <ul className="d-flex justify-content-center justify-content-md-end ps-0">
              ...
              <li className="me-2">
                  <a href="#" className="ms-0 color-main ps-1 text-decoration-none">
                  <FaLock className="me-1 mb-1"/>Sign Up</a>
      ...
      <section className="nav-medium">
        ...
        <Navbar.Collapse id="responsive-navbar-nav" className="flex-grow-0">
          <Nav className="me-auto">
            <Nav.Link href="#" className="fw-bold text-dark px-4">Home</Nav.Link>
            <Nav.Link href="#" className="fw-bold text-dark px-4">Features</Nav.Link>
            <Nav.Link href="#" className="fw-bold text-dark px-4">About</Nav.Link>
            <Nav.Link href="#" className="fw-bold text-dark px-4">Shop Blog</Nav.Link>
            <Nav.Link href="#" className="fw-bold text-dark px-4">Contact</Nav.Link>
          </Nav>
      ...
      <section className="nav-button border-top">
        <Navbar collapseOnSelect expand="lg" bg="light" className="p-md-0 p-2">
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto">
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">Liga BBVA</Nav.Link>
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">UEFA</Nav.Link>
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">EPL</Nav.Link>
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">Super Cup</Nav.Link>
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">World Cup</Nav.Link>
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">NPL</Nav.Link>
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">Nation League</Nav.Link>
              <Nav.Link href="#" className="fw-bold text-dark b-start px-4">Archive</Nav.Link>
            </Nav>
