  ...
  return (
    <>
      <section className="title my-5">
        <div className="board-score-bg pb-3 blog-1 border-botton-news">
        ...
        <div className="board-score-bg pb-3 mt-5 blog-2 border-botton-news">
          <div className="widget-title">
        ...
        <div className="board-score-bg timelint pb-4 mt-5 blog-3 border-botton-news">
          <div className="widget-title">
              ...
              <div className="timeline">
                <div className="timeline-element">
                  <div className="timeline-element-content">
                      ...
                      <span className="text-secondary timeline-element-date">9:30 AM</span>
                  </div>
                </div>
                <div className="timeline-element">
                  <div className="timeline-element-content">
                      <p className="text-white">Best Player in Europe final three: Cristiano Ronaldo</p> 
                      <span className="text-white timeline-element-date">12:25 PM</span>
                  </div>
                </div>
                <div className="timeline-element">
                  <div className="timeline-element-content">
                      <p className="text-secondary">Best Player in Europe final three: Cristiano Ronaldo</p> 
                      <span className="text-secondary timeline-element-date">12:25 PM</span>
                  </div>
                </div>
                <div className="timeline-element">
                  <div className="timeline-element-content">
