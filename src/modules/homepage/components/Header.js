            ...
            <Col lg={6}>
              ...
              <Col lg={6}>
                <ul className="d-flex justify-content-center justify-content-md-start ps-0 mb-0">
                  <li className="me-3">
                    <p className="text-white text-center mb-0 font-time-head">36<span className="ps-3">:</span></p>
                    <p className="text-white fw-bolder mb-0">Days</p>
                  </li>
                  <li className="me-3">
                    <p className="text-white text-center mb-0 font-time-head">28<span className="ps-3">:</span></p>
                    <p className="text-white fw-bolder mb-0">Hours</p>
                  </li>
                  <li className="me-3">
                    <p className="text-white text-center mb-0 font-time-head">54<span className="ps-3">:</span></p>
                    <p className="text-white fw-bolder mb-0">Minutes</p>
                  </li>
                  <li className="me-3">
                    <p className="text-white text-center mb-0 font-time-head">06<span className="ps-3"></span></p>
